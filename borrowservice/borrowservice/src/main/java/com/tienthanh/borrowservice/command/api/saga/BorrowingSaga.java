package com.tienthanh.borrowservice.command.api.saga;
...
import com.tienthanh.commonservice.command.RollBackStatusBookCommand;
import com.tienthanh.commonservice.command.UpdateStatusBookCommand;
import com.tienthanh.commonservice.event.BookRollBackStatusEvent;
	...
	private void handle(BookUpdateStatusEvent event) {
		...
		try {
			...
			EmployeeResponseCommonModel employeeResponseCommonModel = queryGateway
					.query(getDetailsEmployeeQuery, ResponseTypes.instanceOf(EmployeeResponseCommonModel.class)).join();
